...
TARGET_COPY_OUT_VENDOR_OVERLAY := $(_vendor_overlay_path_placeholder)
...
TARGET_OUT_VENDOR_OVERLAY := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_VENDOR_OVERLAY)
...
target_out_vendor_overlay_shared_libraries_base := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_ASAN)/$(TARGET_COPY_OUT_VENDOR_OVERLAY)
ifeq ($(SANITIZE_LITE),true)
# When using SANITIZE_LITE, APKs must not be packaged with sanitized libraries, as they will not
# work with unsanitized app_process. For simplicity, generate APKs into /data/asan/.
target_out_vendor_app_base := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_ASAN)/$(TARGET_COPY_OUT_VENDOR)
target_out_vendor_overlay_app_base := $(PRODUCT_OUT)/$(TARGET_COPY_OUT_ASAN)/$(TARGET_COPY_OUT_VENDOR_OVERLAY)
else
target_out_vendor_app_base := $(TARGET_OUT_VENDOR)
target_out_vendor_overlay_app_base := $(TARGET_OUT_VENDOR_OVERLAY)
endif
else
target_out_vendor_shared_libraries_base := $(TARGET_OUT_VENDOR)
target_out_vendor_overlay_shared_libraries_base := $(TARGET_OUT_VENDOR_OVERLAY)
target_out_vendor_app_base := $(TARGET_OUT_VENDOR)
target_out_vendor_overlay_app_base := $(TARGET_OUT_VENDOR_OVERLAY)
endif

TARGET_OUT_VENDOR_EXECUTABLES := $(TARGET_OUT_VENDOR)/bin
TARGET_OUT_VENDOR_OVERLAY_EXECUTABLES := $(TARGET_OUT_VENDOR_OVERLAY)/bin
TARGET_OUT_VENDOR_OPTIONAL_EXECUTABLES := $(TARGET_OUT_VENDOR)/xbin
TARGET_OUT_VENDOR_OVERLAY_OPTIONAL_EXECUTABLES := $(TARGET_OUT_VENDOR_OVERLAY)/xbin
ifeq ($(TARGET_IS_64_BIT),true)
TARGET_OUT_VENDOR_SHARED_LIBRARIES := $(target_out_vendor_shared_libraries_base)/lib64
TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES := $(target_out_vendor_overlay_shared_libraries_base)/lib64
else
TARGET_OUT_VENDOR_SHARED_LIBRARIES := $(target_out_vendor_shared_libraries_base)/lib
TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES := $(target_out_vendor_overlay_shared_libraries_base)/lib
endif
TARGET_OUT_VENDOR_RENDERSCRIPT_BITCODE := $(TARGET_OUT_VENDOR_SHARED_LIBRARIES)
TARGET_OUT_VENDOR_OVERLAY_RENDERSCRIPT_BITCODE := $(TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES)
TARGET_OUT_VENDOR_JAVA_LIBRARIES := $(TARGET_OUT_VENDOR)/framework
TARGET_OUT_VENDOR_OVERLAY_JAVA_LIBRARIES := $(TARGET_OUT_VENDOR_OVERLAY)/framework
TARGET_OUT_VENDOR_APPS := $(target_out_vendor_app_base)/app
TARGET_OUT_VENDOR_OVERLAY_APPS := $(target_out_vendor_overlay_app_base)/app
TARGET_OUT_VENDOR_APPS_PRIVILEGED := $(target_out_vendor_app_base)/priv-app
TARGET_OUT_VENDOR_OVERLAY_APPS_PRIVILEGED := $(target_out_vendor_overlay_app_base)/priv-app
TARGET_OUT_VENDOR_ETC := $(TARGET_OUT_VENDOR)/etc
TARGET_OUT_VENDOR_OVERLAY_ETC := $(TARGET_OUT_VENDOR_OVERLAY)/etc
.KATI_READONLY := \
  TARGET_OUT_VENDOR_EXECUTABLES \
  TARGET_OUT_VENDOR_OVERLAY_EXECUTABLES \
  TARGET_OUT_VENDOR_OPTIONAL_EXECUTABLES \
  TARGET_OUT_VENDOR_OVERLAY_OPTIONAL_EXECUTABLES \
  TARGET_OUT_VENDOR_SHARED_LIBRARIES \
  TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES \
  TARGET_OUT_VENDOR_RENDERSCRIPT_BITCODE \
  TARGET_OUT_VENDOR_OVERLAY_RENDERSCRIPT_BITCODE \
  TARGET_OUT_VENDOR_JAVA_LIBRARIES \
  TARGET_OUT_VENDOR_OVERLAY_JAVA_LIBRARIES \
  TARGET_OUT_VENDOR_APPS \
  TARGET_OUT_VENDOR_OVERLAY_APPS \
  TARGET_OUT_VENDOR_APPS_PRIVILEGED \
  TARGET_OUT_VENDOR_OVERLAY_APPS_PRIVILEGED \
  TARGET_OUT_VENDOR_ETC \
  TARGET_OUT_VENDOR_OVERLAY_ETC
...
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_EXECUTABLES := $(TARGET_OUT_VENDOR_OVERLAY_EXECUTABLES)
ifeq ($(TARGET_TRANSLATE_2ND_ARCH),true)
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES := $(target_out_vendor_overlay_shared_libraries_base)/lib/$(TARGET_2ND_ARCH)
else
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES := $(target_out_vendor_overlay_shared_libraries_base)/lib
endif
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_RENDERSCRIPT_BITCODE := $($(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES)
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_APPS := $(TARGET_OUT_VENDOR_OVERLAY_APPS)
$(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_APPS_PRIVILEGED := $(TARGET_OUT_VENDOR_OVERLAY_APPS_PRIVILEGED)
.KATI_READONLY := \
  ...
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_EXECUTABLES \
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES \
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_RENDERSCRIPT_BITCODE \
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_APPS \
  $(TARGET_2ND_ARCH_VAR_PREFIX)TARGET_OUT_VENDOR_OVERLAY_APPS_PRIVILEGED
...
TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES_UNSTRIPPED := $(TARGET_OUT_UNSTRIPPED)/$(TARGET_COPY_OUT_VENDOR_OVERLAY)/lib
...
.KATI_READONLY := \
  ...
  TARGET_OUT_VENDOR_OVERLAY_SHARED_LIBRARIES_UNSTRIPPED \
